...
const masterDiv = $(`<div class="master"></div>`);
const headerDiv = $(`<div class="header"></div>`);
const iconDiv = $(`<div class="iconDiv"></div>`);
const logoDiv = $(`<div class="logoDiv"></div>`);
const body = $("body");
const pinIcon =
...
const logo = $(`<h2 class="logo">Shopping</h2>`);
const modeButton = $(`<button class="mode">Mode</button>`)
iconDiv.append(pinIcon, bucketIcon, searchInputField);
headerDiv.append(iconDiv, logoDiv);
masterDiv.append(headerDiv);
logoDiv.append(logo,modeButton);
const render = ()=>{
